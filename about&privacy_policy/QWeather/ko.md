...
- 사용자가 활성화하면 현재 위치 위젯과 상시 날씨 알림은 Q Weather가 닫혀 있는 동안 백그라운드에서 기기의 위치에 액세스하여 표시되는 예보를 업데이트할 수 있습니다.
- 백그라운드 위치 사용은 사용자가 활성화한 이러한 날씨 기능에만 사용되며 광고, 분석 또는 추적에는 사용되지 않습니다.
